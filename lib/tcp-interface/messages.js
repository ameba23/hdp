...
function defineClientMessage () {
  ...
  function encodingLength (obj) {
    var length = 0
    if ((+defined(obj.readdir) + +defined(obj.open) + +defined(obj.read) + +defined(obj.close) + +defined(obj.cat) + +defined(obj.find) + +defined(obj.download)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
...
function defineServerMessage () {
  ...
  function defineSuccess () {
    ...
    function encodingLength (obj) {
      var length = 0
      if ((+defined(obj.readdir) + +defined(obj.open) + +defined(obj.read) + +defined(obj.close) + +defined(obj.cat) + +defined(obj.find) + +defined(obj.download) + +defined(obj.endResponse)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
      if (defined(obj.readdir)) {
        var len = Readdir.encodingLength(obj.readdir)
        length += varint.encodingLength(len)
        length += 1 + len
