...
function defineClientMessage () {
  ...
  function encodingLength (obj) {
    var length = 0
    if ((+defined(obj.readdir) + +defined(obj.open) + +defined(obj.read) + +defined(obj.close) + +defined(obj.cat) + +defined(obj.find) + +defined(obj.download) + +defined(obj.wishlist)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
...
function defineServerMessage () {
  ...
  function defineSuccess () {
    ...
    function encodingLength (obj) {
      var length = 0
      if ((+defined(obj.endResponse) + +defined(obj.readdir) + +defined(obj.open) + +defined(obj.read) + +defined(obj.close) + +defined(obj.cat) + +defined(obj.find) + +defined(obj.download) + +defined(obj.wishlist)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
