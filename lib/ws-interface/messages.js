...
function defineServerMessage () {
  ...
  var DownloadedFile = ServerMessage.DownloadedFile = {
    buffer: true,
    encodingLength: null,
    encode: null,
    decode: null
  ...
  var Downloaded = ServerMessage.Downloaded = {
    buffer: true,
    encodingLength: null,
    encode: null,
    decode: null
  ...
  function defineDownloadedFile () {
    DownloadedFile.encodingLength = encodingLength
    DownloadedFile.encode = encode
    DownloadedFile.decode = decode
    ...
    function encodingLength (obj) {
      ...
      var len = encodings.string.encodingLength(obj.localPath)
      length += 1 + len
    ...
    function encode (obj, buf, offset) {
      ...
      if (!defined(obj.localPath)) throw new Error("localPath is required")
      buf[offset++] = 18
      encodings.string.encode(obj.localPath, buf, offset)
      offset += encodings.string.encode.bytes
      if (!defined(obj.timestamp)) throw new Error("timestamp is required")
      buf[offset++] = 24
    ...
    function decode (buf, offset, end) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          break
          case 2:
          obj.localPath = encodings.string.decode(buf, offset)
          offset += encodings.string.decode.bytes
          found1 = true
          break
          case 3:
  ...
  function defineDownloaded () {
    Downloaded.encodingLength = encodingLength
    Downloaded.encode = encode
    Downloaded.decode = decode

    function encodingLength (obj) {
      var length = 0
      if (defined(obj.downloadedFiles)) {
        for (var i = 0; i < obj.downloadedFiles.length; i++) {
          if (!defined(obj.downloadedFiles[i])) continue
          var len = DownloadedFile.encodingLength(obj.downloadedFiles[i])
          length += varint.encodingLength(len)
          length += 1 + len
        }
      }
    ...
    function encode (obj, buf, offset) {
      ...
      if (defined(obj.downloadedFiles)) {
        for (var i = 0; i < obj.downloadedFiles.length; i++) {
          if (!defined(obj.downloadedFiles[i])) continue
          buf[offset++] = 10
          varint.encode(DownloadedFile.encodingLength(obj.downloadedFiles[i]), buf, offset)
          offset += varint.encode.bytes
          DownloadedFile.encode(obj.downloadedFiles[i], buf, offset)
          offset += DownloadedFile.encode.bytes
        }
      }
      encode.bytes = offset - oldOffset
      return buf
    ...
    function decode (buf, offset, end) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          var len = varint.decode(buf, offset)
          offset += varint.decode.bytes
          obj.downloadedFiles.push(DownloadedFile.decode(buf, offset, offset + len))
          offset += DownloadedFile.decode.bytes
          break
          default:
          offset = skip(prefix & 7, buf, offset)
        }
  ...
  function defineSuccess () {
    ...
    function encodingLength (obj) {
      var length = 0
      if ((+defined(obj.endResponse) + +defined(obj.ls) + +defined(obj.cat) + +defined(obj.download) + +defined(obj.upload) + +defined(obj.wishlist) + +defined(obj.swarm) + +defined(obj.peerConnected) + +defined(obj.peerDisconnected) + +defined(obj.downloaded)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
      ...
      if (defined(obj.downloaded)) {
        var len = Downloaded.encodingLength(obj.downloaded)
        length += varint.encodingLength(len)
        length += 1 + len
      }
      return length
    ...
    function encode (obj, buf, offset) {
      ...
      if (defined(obj.downloaded)) {
        buf[offset++] = 82
        varint.encode(Downloaded.encodingLength(obj.downloaded), buf, offset)
        offset += varint.encode.bytes
        Downloaded.encode(obj.downloaded, buf, offset)
        offset += Downloaded.encode.bytes
      }
      encode.bytes = offset - oldOffset
      return buf
    }
    ...
    function decode (buf, offset, end) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          var len = varint.decode(buf, offset)
          offset += varint.decode.bytes
          obj.downloaded = Downloaded.decode(buf, offset, offset + len)
          offset += Downloaded.decode.bytes
          break
          default:
          offset = skip(prefix & 7, buf, offset)
        }
