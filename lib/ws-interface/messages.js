...
function defineServerMessage () {
  ...
  function defineSuccess () {
    ...
    function encodingLength (obj) {
      var length = 0
      if ((+defined(obj.endResponse) + +defined(obj.ls) + +defined(obj.cat) + +defined(obj.download) + +defined(obj.upload) + +defined(obj.wishlist) + +defined(obj.swarm)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
