...
function defineRequest () {
  ...
  function encodingLength (obj) {
    var length = 0
    if ((+defined(obj.handshake) + +defined(obj.ls) + +defined(obj.open) + +defined(obj.read) + +defined(obj.close)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
...
function defineResponse () {
  ...
  function defineSuccess () {
    ...
    function encodingLength (obj) {
      var length = 0
      if ((+defined(obj.handshake) + +defined(obj.ls) + +defined(obj.open) + +defined(obj.read) + +defined(obj.close) + +defined(obj.find)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
      if (defined(obj.handshake)) {
        var len = Handshake.encodingLength(obj.handshake)
        length += varint.encodingLength(len)
        length += 1 + len
      ...
      if (defined(obj.partial)) {
        var len = encodings.bool.encodingLength(obj.partial)
        length += 1 + len
      }
      return length
    }
    ...
    function encode (obj, buf, offset) {
      ...
      if (defined(obj.partial)) {
        buf[offset++] = 56
        encodings.bool.encode(obj.partial, buf, offset)
        offset += encodings.bool.encode.bytes
      }
      encode.bytes = offset - oldOffset
      return buf
    ...
    function decode (buf, offset, end) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          break
          case 7:
          obj.partial = encodings.bool.decode(buf, offset)
          offset += encodings.bool.decode.bytes
          break
          default:
          offset = skip(prefix & 7, buf, offset)
