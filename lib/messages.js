...
function defineRequest () {
  ...
  function encodingLength (obj) {
    var length = 0
    if ((+defined(obj.handshake) + +defined(obj.readdir) + +defined(obj.open) + +defined(obj.read) + +defined(obj.close) + +defined(obj.find)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
